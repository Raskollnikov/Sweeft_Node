...
exports.changePasswordSchema = exports.updateCompanySchema = exports.loginSchema = exports.companySchema = void 0;
...
exports.updateCompanySchema = zod_1.z.object({
    name: zod_1.z.string().min(3, "Name must be at least 3 characters").max(100, "Name must be less than 100 characters").optional(),
    country: zod_1.z.string().min(3, "Country name must be at least 3 characters").optional(),
    industry: zod_1.z.string().min(3, "Industry name must be at least 3 characters").optional(),
});
